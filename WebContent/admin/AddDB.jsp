...
try{
	...
	XmlToDb.RUN("G:\\Thibault\\Olivier\\MnR\\Databases\\EBV_Proteome3.clusterML", "dev");
	//XmlToDb.RUN("C:\\Documents and Settings\\ProteoAdmin\\Desktop\\AEffacer\\___MnR_EBV_5ppm\\PigInfo.clusterML", "dev");
